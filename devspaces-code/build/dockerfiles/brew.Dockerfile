...
FROM registry.redhat.io/ubi8/nodejs-20:1-73.1742991506 as checode-linux-libc-ubi8-builder
...
FROM registry.redhat.io/ubi9/go-toolset:9.5-1742984157 as machineexec-builder
ENV GOPATH=/go/
# hadolint ignore=DL3002
USER root
